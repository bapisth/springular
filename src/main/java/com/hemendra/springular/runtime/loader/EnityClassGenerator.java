...
public class EnityClassGenerator {
    ...
    public static final String packageName = "com.hemendra.springular.generated.enity";
    ...
    public static ClassWriter generateClass(String className) {
        ...
        //new EnityClassGenerator().createTableDynamically(className);
        return WRITER;
    }
    ...
    private static void createDatabaseTable(String className) {
        ...
        Session currentSession = new EnityClassGenerator().getSessionFactory().openSession();
    ...
    private static ClassWriter createClassWriter(ClassWriter writer, String className) {
        writer.visit(V1_7,                              // Java 1.7
                ...
                new String[]{}); // interfaces Calculator.class.getName().replace(".", "/")
        /**
